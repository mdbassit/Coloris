 ...
 (function(window, document, Math) {
     ...
     function attachVirtualInstance(element) {
         if (hasInstance) {
             ...
             var unsupportedOptions = ['el', 'wrap', 'inline', 'defaultColor', 'a11y'];
     ...
     function bindFields(selector) {
         ...
         addListener(document, 'click', selector, function(event) {
             ...
             updatePickerPosition();
             setColorFromStr(oldColor, event.target.style.backgroundColor);
      ...
      */
     function setColorFromStr(str, other) {
     ...
     function pickColor(color) {
         ...
         if (currentEl) {
             ...
             if (currentEl.classList.contains('coloris-full')) {
